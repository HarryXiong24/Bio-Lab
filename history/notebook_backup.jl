...
# ╔═╡ 6ac0dd0d-e19e-4a26-8efd-d59f39dd8eb3
# begin
...
let
	...
	colormap = to_colormap(:jet)
	colormap[1:3] .= RGBAf(0, 0, 0, 0) 
	...
	Colorbar(fig2[1, 2], colormap=:jet, flipaxis=false)
...
let
	@load "/Users/harryxiong24/Code/Lab/perfusion/limb/pred.jld2" ŷ
	fig3 = Figure(resolution = (1200, 1000))
	
	ax = GLMakie.Axis3(fig3[1, 1]; 
	    perspectiveness = 0.5,
	    azimuth = 2.19,
	    elevation = 0.57,
	    aspect = (1, 1, 1)
	...
	# slider = GLMakie.Slider(fig2[0, 1:2], range = 1:6, startvalue = 4)

	# segment = lift(slider.value) do new_value
	#   new_value
	# end
	...
	Colorbar(fig3[1, 2], colormap=:jet, flipaxis=false)
